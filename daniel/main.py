...
def run_pipeline():
    ...
    default_args = {
        ...
        'filter_threshold': (0.65, 0),     # filter threshold (gene expression, copy number varation)
        ...
        'outputfile': 'sc3_daniel_phase3',              # output file name
...
#                 for estimators in [{'rdgcv': {'normalize': True}}]]
